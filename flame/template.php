 ...
 */
function flame_preprocess_page(&$variables) {

  // Social Block Settings.
  $variables['facebook_url'] = check_url(theme_get_setting('facebook_url', 'flame'));
  $variables['twitter_url'] = check_url(theme_get_setting('twitter_url', 'flame'));
  $variables['gplus_url'] = check_url(theme_get_setting('gplus_url', 'flame'));
  $variables['pinterest_url'] = check_url(theme_get_setting('pinterest_url', 'flame'));

  // Social Icons path.
  $variables['path'] = base_path() . path_to_theme('theme', 'flame');
}
 ...
 */
function flame_links__system_secondary_menu($variables) {
 ...
 */
function flame_links__system_main_menu($variables) {
  $links = $variables['links'];
  $attributes = $variables['attributes'];
  $heading = $variables['heading'];
  global $language_url;
 ...
 */
function _flame_browsers_to_array($browsers) {
  switch ($browsers) {
    case 'modern':
 ...
 */
function _flame_add_html_head_bottom($data = NULL) {
 ...
 */
function flame_page_alter($page) {
  $viewport = array(
    '#type' => 'html_tag',
    '#tag' => 'meta',
    '#attributes' => array(
